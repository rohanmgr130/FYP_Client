...
function OrderConfirm() {
  ...
  // Use order details from navigation state or fallback to default values
    ...
    <div className="max-w-md mx-auto bg-white shadow-lg rounded-lg overflow-hidden min-h-screen flex flex-col">
      ...
      <div className="p-6 text-center">
        ...
        <div className="bg-gray-50 rounded-lg p-3 mb-4">
          <p className="text-gray-500">Order ID: <span className="font-medium text-gray-800">{orderDetails.orderId}</span></p>
          <p className="text-gray-500">Date: <span className="font-medium text-gray-800">{orderDetails.orderDate}</span></p>
        </div>
      </div>
